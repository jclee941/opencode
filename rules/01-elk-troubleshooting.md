...
Domain-specific sections activate via child rules:
- OpenCode: `02-elk-troubleshooting-opencode.md`
- Proxmox: `03-elk-troubleshooting-proxmox.md`
...
- OpenCode runtime: See `02-elk-troubleshooting-opencode.md`
- Proxmox infrastructure: See `03-elk-troubleshooting-proxmox.md`
